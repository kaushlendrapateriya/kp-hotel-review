...
const ReviewsContextProvider = ({ children }) => {
    ...
    const getReviewsRequest = async id => {
        const result = await Api.fetchData(
            `https://my-json-server.typicode.com/kaushlendrapateriya/kp-hotel-review/hotels/${id}/reviews`,
        );
    ...
    const addReviewRequest = async content => {
        const result = await Api.postData(
            'https://my-json-server.typicode.com/kaushlendrapateriya/kp-hotel-review/hotels',
            content,
        );
